...
export default function VehicleEdit({ vehicle }: VehicleEditProps) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Modifica ${vehicle.model}`} />
            <PageMain>
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h1 className="text-3xl font-bold">Modifica Veicolo</h1>
                        <p className="text-muted-foreground">Aggiorna i dettagli del tuo veicolo</p>
                    </div>
                    <Link href="/vehicles">
